...
public class PictureBarcodeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (imageUri != null) {
                ...
                txtResultsBody.setText(savedInstanceState.getString(SAVED_INSTANCE_RESULT));
            }
        }
        detector = new
                BarcodeDetector.Builder(getApplicationContext())
                .setBarcodeFormats(Barcode.DATA_MATRIX | Barcode.QR_CODE)
                .build();

        if (!detector.isOperational()) {
            txtResultsBody.setText(getString(R.string.failed));
            return;
        }
    }

    private void initViews() {
        txtResultsBody = findViewById(R.id.txtResultsBody);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btnOpenCamera) {
            Log.i("Clicked", "It should be working!");
            ...
            Log.i("Clicked", "Something is wrong");
            ...
            try {
                ...
                if (detector.isOperational() && bitmap != null) {
                    ...
                    for (int index = 0; index < barcodes.size(); index++) {
                        ...
                        txtResultsBody.setText(txtResultsBody.getText() + "\n" + code.displayValue + "\n");
                    ...
                    if (barcodes.size() == 0) {
                        txtResultsBody.setText("No barcode could be detected. Please try again.");
                    }
                } else {
                    txtResultsBody.setText("Detector initialisation failed.");
                }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        if (imageUri != null) {
            ...
            outState.putString(SAVED_INSTANCE_RESULT, txtResultsBody.getText().toString());
        }
