...
public class ScannedBarcodeActivity extends AppCompatActivity {
                ...
                if (intentData.length() > 0) {
                    if (isEmail)
                        startActivity(new Intent(ScannedBarcodeActivity.this,
                                EmailActivity.class).putExtra("email_address", intentData));
    ...
    private void initialiseDetectorAndSources() {
        ...
        cameraSource = new CameraSource.Builder(this, barcodeDetector)
                .setRequestedPreviewSize(1920,
                        1080)
                .setAutoFocusEnabled(true) //add this feature
                .build();
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(ScannedBarcodeActivity.this,
                        ...
                        Log.i("Camera", "It should be working!");
                        cameraSource.start(surfaceView.getHolder());
                    } else {
                        Log.i("Camera", "Something is wrong!");
        ...
        barcodeDetector.setProcessor(new Detector.Processor<Barcode>() {
            @Override
            public void release() {
                Toast.makeText(getApplicationContext(), "To prevent memory leaks barcode scanner " +
                        "has stopped", Toast.LENGTH_SHORT).show();
            }
